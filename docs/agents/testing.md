...
`python3 hack/jira-render-evidence.py all --json` reproduces every `rendered.html` in the directory; `round6` is the newest round, and a new archive's probe belongs there.
